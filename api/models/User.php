<?php
// =================================================================
// Model για την οντότητα User
// Χρήση: Διαχείριση χρηστών στην εφαρμογή.
// Περιλαμβάνει λειτουργίες για εύρεση, εγγραφή, ενημέρωση, διαγραφή χρηστών,
// έγκριση/απόρριψη αιτημάτων εγγραφής, και ανάγνωση χρηστών.
// =================================================================
